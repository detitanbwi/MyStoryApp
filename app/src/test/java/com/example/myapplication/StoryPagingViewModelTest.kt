...
class StoryPagingViewModelTest{
    ...
    @get:Rule
    val mainDispatcherRules = MyDispatcherRule.MainDispatcherRule()
    @Mock
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val storyPagingViewModel = StoryPagingViewModel(storyRepository)
        val actualStory: PagingData<ListStoryItem> = storyPagingViewModel.story.getOrAwaitValue()
